...
export const uniswap = async (address: string): Promise<float32> => {
    const response = await managementCanister
		.http_request({
			url: `https://eth-mainnet.g.alchemy.com/v2/${process.env.ALCHEMY_ETH}/getNFTs?owner=${address}&withMetadata=false&contractAddresses[]=0xc36442b4a4522e871399cd717abdd847ab11fe88`,
